...
console.log("Fetched Recipe Data:", data.value);
...
<template>
    <div v-if="data" class="flex flex-col max-w-screen-lg container py-20">
      <!-- Header -->
    ...
    <p v-else class="text-center text-lg text-gray-500">Loading recipe...</p>
  </template>
